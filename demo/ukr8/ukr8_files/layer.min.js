! function(h) {
    ...
    function t(e) {
        ...
        var i = this;
        i.index = ++g.index, i.config.maxWidth = m(f).width() - 30, i.config = m.extend({}, i.config, c.config, e), document.body ? t() : setTimeout(function() {
            t()
        }, 30)
    }
    var m, f, e, n = h.layui && layui.define,
        c = {
            getPath: (e = document.currentScript ? document.currentScript.src : function() {
                ...
                return e || t[i].src
            }(), (h.LAYUI_GLOBAL || {}).layer_dir || e.substring(0, e.lastIndexOf("/") + 1)),
            config: {},
            end: {},
            minIndex: 0,
            minLeft: [],
            ...
            link: function(e, n, t) {
                var i, a, o, s, r, l;
                g.path && (i = document.getElementsByTagName("head")[0], a = document.createElement("link"), o = ((t = "string" == typeof n ? n : t) || e).replace(/\.|\//g, ""), s = "layuicss-" + o, r = "creating", l = 0, a.rel = "stylesheet", a.href = g.path + e, a.id = s, document.getElementById(s) || i.appendChild(a), "function" == typeof n && function e(t) {
                    var i = document.getElementById(s);
                    return 100 < ++l ? h.console && console.error(o + ".css: Invalid") : void(1989 === parseInt(c.getStyle(i, "width")) ? (t === r && i.removeAttribute("lay-status"), i.getAttribute("lay-status") === r ? setTimeout(e, 100) : n()) : (i.setAttribute("lay-status", r), setTimeout(function() {
                        e(r)
                    }, 100)))
                }())
            }
        ...
        g = {
            v: "3.5.1",
            ie: (e = navigator.userAgent.toLowerCase(), !!(h.ActiveXObject || "ActiveXObject" in h) && ((e.match(/msie\s(\d+)/) || [])[1] || "11")),
            index: h.layer && h.layer.v ? 1e5 : 0,
            path: c.getPath,
            config: function(e, t) {
                return g.cache = c.config = m.extend({}, c.config, e = e || {}), g.path = c.config.path || g.path, "string" == typeof e.extend && (e.extend = [e.extend]), c.config.path && g.ready(), e.extend && (n ? layui.addcss("modules/layer/" + e.extend) : c.link("theme/" + e.extend)), this
            },
            ready: function(e) {
                var t = "layer",
            ...
            msg: function(e, t, i) {
                ...
                return n && (i = t), g.open(m.extend({
                    ...
                    anim: a
                } : (-1 !== (t = t || {}).icon && (void 0 !== t.icon || c.config.skin) || (t.skin = o + " " + (t.skin || "layui-layer-hui")), t)))
            },
            load: function(e, t) {
                return g.open(m.extend({
                    type: 3,
    ...
    d.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], d.SHADE = "layui-layer-shade", d.MOVE = "layui-layer-move", t.pt.config = {
        ...
        }() : "") + (n.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], o, m('<div class="' + d.MOVE + '" id="' + d.MOVE + '"></div>')), this
    }, t.pt.creat = function() {
        var e, n = this,
            a = n.config,
            o = n.index,
        ...
        if (!a.id || !m("#" + a.id)[0]) {
            switch ("string" == typeof a.area && (a.area = "auto" === a.area ? ["", ""] : [a.area, ""]), a.shift && (a.anim = a.shift), 6 == g.ie && (a.fixed = !1), a.type) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    s || (a.content = [a.content, "body"]), a.follow = a.content[1], a.content = a.content[0] + '<i class="layui-layer-TipsG"></i>', delete a.title, a.tips = "object" == typeof a.tips ? a.tips : [a.tips, !0], a.tipsMore || g.closeAll("tips")
            }
            n.vessel(s, function(e, t, i) {
                r.append(e[0]), s ? 2 == a.type || 4 == a.type ? m("body").append(e[1]) : l.parents("." + d[0])[0] || (l.data("display", l.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]), m("#" + d[0] + o).find("." + d[5]).before(t)) : r.append(e[1]), m("#" + d.MOVE)[0] || r.append(c.moveElem = i), n.layero = m("#" + d[0] + o), n.shadeo = m("#" + d.SHADE + o), a.scrollbar || d.html.css("overflow", "hidden").attr("layer-full", o)
            }).auto(o), n.shadeo.css({
                "background-color": a.shade[1] || "#000",
                opacity: a.shade[0] || a.shade
            }), 2 == a.type && 6 == g.ie && n.layero.find("iframe").attr("src", l[0]), 4 == a.type ? n.tips() : (n.offset(), parseInt(c.getStyle(document.getElementById(d.MOVE), "z-index")) || (n.layero.css("visibility", "hidden"), g.ready(function() {
        ...
        var t = this.config,
            i = m("#" + d[0] + e);
        "" === t.area[0] && 0 < t.maxWidth && (g.ie && g.ie < 8 && t.btn && i.width(i.innerWidth()), i.outerWidth() > t.maxWidth && i.width(t.maxWidth));
        ...
        var e = this.config,
            ...
            n = m(e.follow),
            a = {
                width: (n = !n[0] ? m("body") : n).outerWidth(),
        ...
        return s.move && t.css("cursor", "move"), t.on("mousedown", function(e) {
            ...
            var t, i, n, a;
            l.moveStart && (n = e.clientX - l.offset[0], a = e.clientY - l.offset[1], i = "fixed" === r.css("position"), e.preventDefault(), l.stX = i ? 0 : f.scrollLeft(), l.stY = i ? 0 : f.scrollTop(), s.moveOut || (t = f.width() - r.outerWidth() + l.stX, i = f.height() - r.outerHeight() + l.stY, t < (n = n < l.stX ? l.stX : n) && (n = t), i < (a = a < l.stY ? l.stY : a) && (a = i)), r.css({
                left: n,
                top: a
            })), s.resize && l.resizeStart && (n = e.clientX - l.offset[0], a = e.clientY - l.offset[1], e.preventDefault(), g.style(o.index, {
                width: l.area[0] + n,
                height: l.area[1] + a
        ...
        t.openLayer(), n.success && (2 == n.type ? i.find("iframe").on("load", function() {
            n.success(i, t.index)
        }) : n.success(i, t.index)), 6 == g.ie && t.IE6(i), i.find("." + d[6]).children("a").on("click", function() {
            var e = m(this).index();
            ...
            m(this).hasClass("layui-layer-maxmin") ? (g.restore(t.index), n.restore && n.restore(i, t.index)) : (g.full(t.index, n), setTimeout(function() {
        ...
        m.each(m("select"), function(e, t) {
            var i = m(this);
            i.parents("." + d[0])[0] || 1 == i.attr("layer") && m("." + d[0]).length < 1 && i.removeAttr("layer").show(), i = null
        })
    }, t.pt.IE6 = function(e) {
    ...
    }, (h.layer = g).getChildFrame = function(e, t) {
        ...
        var t, i, n;
        e && (t = g.getChildFrame("html", e).outerHeight(), n = (i = m("#" + d[0] + e)).find(d[1]).outerHeight() || 0, e = i.find("." + d[6]).outerHeight() || 0, i.css({
            height: t + n + e
        }), i.find("iframe").css({
            height: t
        }))
        ...
        var n = m("#" + d[0] + e),
            ...
            e = n.find("." + d[6]).outerHeight() || 0;
        n.attr("minLeft"), o !== c.type[3] && o !== c.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260), parseFloat(t.height) - s - e <= 64 && (t.height = 64 + s + e)), n.css(t), e = n.find("." + d[6]).outerHeight(), o === c.type[2] ? n.find("iframe").css({
            height: parseFloat(t.height) - s - e
        }) : a.css({
            height: parseFloat(t.height) - s - e - parseFloat(a.css("padding-top")) - parseFloat(a.css("padding-bottom"))
        }))
    }, g.min = function(e, t) {
        t = t || {};
        var i = m("#" + d[0] + e),
        ...
        c.record(i), c.minLeft[0] && (o = c.minLeft[0], c.minLeft.shift()), t.minStack && (r.left = o, r.top = f.height() - a, i.attr("minLeft") || c.minIndex++, i.attr("minLeft", o)), i.attr("position", s), g.style(e, r, !0), i.find(".layui-layer-min").hide(), "page" === i.attr("type") && i.find(d[4]).hide(), c.rescollbar(e), n.hide()
        ...
        s[0] && (o = "layui-layer-wrap", e = function() {
            if (r === c.type[1] && "object" === s.attr("conType")) {
                ...
                if (r === c.type[2]) try {
                    var i = m("#" + d[4] + n)[0];
                    i.contentWindow.document.write(""), i.contentWindow.close(), s.find("." + d[5])[0].removeChild(i)
                } catch (e) {}
                s[0].innerHTML = "", s.remove()
            }
            "function" == typeof c.end[n] && c.end[n](), delete c.end[n], "function" == typeof a && a()
        }, s.data("isOutAnim") && s.addClass("layer-anim layer-anim-close"), m("#layui-layer-moves, #" + d.SHADE + n).remove(), 6 == g.ie && c.reselect(), c.rescollbar(n), s.attr("minLeft") && (c.minIndex--, c.minLeft.push(s.attr("minLeft"))), g.ie && g.ie < 10 || !s.data("isOutAnim") ? e() : setTimeout(function() {
            e()
        }, 200))
    }, g.closeAll = function(i, n) {
        "function" == typeof i && (n = i, i = null);
        var a = m("." + d[0]);
        m.each(a, function(e) {
            var t = m(this);
            (i ? t.attr("type") === i : 1) && g.close(t.attr("times"), e === a.length - 1 ? n : null)
        }), 0 === a.length && "function" == typeof n && n()
    };
    ...
    g.prompt = function(i, n) {
        ...
        var a, t = 2 == i.formType ? '<textarea class="layui-layer-input"' + t + "></textarea>" : '<input type="' + (1 == i.formType ? "password" : "text") + '" class="layui-layer-input">',
            o = i.success;
        ...
        return delete n.success, g.open(m.extend({
            ...
            success: function(e) {
                ...
                t.on("mousedown", function(e) {
                    ...
                    var t = m(this),
                        e = t.index();
                    t.addClass(o).siblings().removeClass(o), i.eq(e).show().siblings().hide(), "function" == typeof n.change && n.change(e)
        ...
        var t, a, o, s, r = {};
        if ((i = i || {}).photos) {
            var l = !("string" == typeof i.photos || i.photos instanceof m),
                f = l ? i.photos : {},
                c = f.data || [],
                d = f.start || 0;
            r.imgIndex = 1 + (0 | d), i.img = i.img || "img";
            var u = i.success;
            if (delete i.success, l) {
                if (0 === c.length) return g.msg("&#x6CA1;&#x6709;&#x56FE;&#x7247;")
            } else {
                var y = m(i.photos),
                    p = function() {
                        c = [], y.find(i.img).each(function(e) {
                            var t = m(this);
                ...
                if (e || y.on("click", i.img, function() {
                        p();
            ...
            r.imgprev = function(e) {
                r.imgIndex--, r.imgIndex < 1 && (r.imgIndex = c.length), r.tabimg(e)
            }, r.imgnext = function(e, t) {
                r.imgIndex++, r.imgIndex > c.length && (r.imgIndex = 1, t) || r.tabimg(e)
            }, r.keyup = function(e) {
                var t;
                r.end || (t = e.keyCode, e.preventDefault(), 37 === t ? r.imgprev(!0) : 39 === t ? r.imgnext(!0) : 27 === t && g.close(r.index))
            }, r.tabimg = function(e) {
                if (!(c.length <= 1)) return f.start = r.imgIndex - 1, g.close(r.index), g.photos(i, !0, e)
            }, r.event = function() {
                ...
                }), m(document).on("keyup", r.keyup)
            }, r.loadi = g.load(1, {
                shade: !("shade" in i) && .9,
                scrollbar: !1
            }), t = c[d].src, a = function(e) {
                var t;
                g.close(r.loadi), n && (i.anim = -1), r.index = g.open(m.extend({
                    type: 1,
                    id: "layui-layer-photos",
                    area: (t = [e.width, e.height], e = [m(h).width() - 100, m(h).height() - 100], !i.full && (t[0] > e[0] || t[1] > e[1]) && ((e = [t[0] / e[0], t[1] / e[1]])[1] < e[0] ? (t[0] = t[0] / e[0], t[1] = t[1] / e[0]) : e[0] < e[1] && (t[0] = t[0] / e[1], t[1] = t[1] / e[1])), [t[0] + "px", t[1] + "px"]),
                    title: !1,
                    shade: .9,
                    shadeClose: !0,
                    closeBtn: !1,
        ...
        f = (m = e)(h), d.html = m("html"), g.open = function(e) {
            return new t(e).index
        }
    }, h.layui && layui.define ? (g.ready(), layui.define("jquery", function(e) {
        g.path = layui.cache.dir, c.run(layui.$), e("layer", h.layer = g)
    })) : "function" == typeof define && define.amd ? define(["jquery"], function() {
        return c.run(h.jQuery), g
    }) : (g.ready(), c.run(h.jQuery))
}(window);